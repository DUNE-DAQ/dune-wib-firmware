...
#define UIO_PATH      "/dev/mem"
#define UIO_BASE_ADDR 0xA0000000
...
#else /* USE_IOCTL */
#error No support for IOCTL XVC on the WIB!
#include <sys/ioctl.h>
#include "xvc_ioctl.h"
...
int main(int argc, char **argv) {
    ...
    ptr = (volatile jtag_t*) mmap(NULL, MAP_SIZE, PROT_READ | PROT_WRITE, MAP_SHARED, fd_uio, UIO_BASE_ADDR);
    if (ptr == MAP_FAILED) {
