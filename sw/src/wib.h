...
constexpr size_t REG_DAQ_FIELDS_1       = 0x0028/4;
constexpr size_t REG_DAQ_FIELDS_2       = 0x0034/4;
constexpr size_t REG_PULSER_CTRL        = 0x003C/4;
constexpr size_t REG_PULSER_PERIOD      = 0x0040/4;
constexpr size_t REG_PULSER_DUR         = 0x0044/4;
